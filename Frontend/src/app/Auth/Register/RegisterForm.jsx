...
const renderLabel = (text, name, isRequired = true) => (
  <Typography
    component="label"
    htmlFor={name}
    sx={{
  ...
  >
    {text} {isRequired && <span style={{ color: "red" }}>*</span>}
    {!isRequired && <span style={{ color: "#888", fontWeight: 400, fontSize: '12px', marginLeft: '5px' }}>(Optional)</span>}
  </Typography>
);
        ...
        <CardContent>
          ...
          <Box component="form" onSubmit={handleSubmit}>
            ...
            <Box display="flex" flexDirection={{ xs: "column", md: "row" }} gap={2} mb={2}>
              ...
              <Box flex={1}>
                {renderLabel("Mobile Number", "phone", true)}
                <TextField
                  name="phone"
                  ...
                  fullWidth
                  error={!!errors.phone}
                  helperText={errors.phone && "Mobile number must be 10 digits"}
                  sx={commonStyles}
