...
const tabConfig = [
  ...
  { label: 'My Wallet', key: 'wallet', component: <WalletTab /> },
...
export default function AccountTabs() {
  ...
  const setCurrentPage = useOrderStore((state) => state.setCurrentPage);
    ...
    <>
      ...
      <Container className="my-20">
        <div className="flex flex-col lg:flex-row w-full gap-0">
          {/* Sidebar Tabs */}
          <div className="w-full h-fit lg:w-1/4 border-2 border-(--primary) rounded-md">
            <p className="border-b-2 border-(--primary) text-center text-transparent bg-clip-text bg-[linear-gradient(to_left,_#996E19_10%,_var(--primary))] font-bold py-3">
              Account
            </p>
