...
const ProductPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col pb-20">
      ...
      {/* Production Calculator - Size Adjusted to Match Card */}
      <Container className="my-10">
        <div className="border-t border-b border-gray-100 py-6">
          <StitchDetails
            backStitches={productDetail.backStitches}
            handStitches={productDetail.handStitches}
            stitches={productDetail.totalStitchesVal || productDetail.stitches}
          />
        </div>
      </Container>

      <Container className="my-5">
        <h3 className="text-center pb-6 text-2xl font-semibold text-gray-800 my-0">
          Related Products
        </h3>
