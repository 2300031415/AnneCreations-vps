  ...
  return (
    <>
      ...
      <Container className="my-10 relative">
        <h1 className="text-center text-3xl font-bold text-(--secondary) mb-10">
          WishList
        </h1>

        {/* Compare Action Bar */}
        {selectedItems.length > 0 && (
          <div className="sticky top-20 z-40 mb-6 bg-(--primary) text-white p-4 rounded-lg shadow-lg flex justify-between items-center animate-in fade-in slide-in-from-top-4 duration-300">
        ...
        {/* Wishlist Content */}
        <div className="w-full bg-white/10 rounded-lg p-4 md:p-6 text-(--secondary)">
          {renderContent()}
        </div>
      </Container>
    </>
