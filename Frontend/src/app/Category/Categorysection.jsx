...
const CategorySection = () => {
  ...
  return (
    <>
      ...
      <h2 className="text-2xl font-bold md:mb-10 text-(--secondary) text-center">
        Shop by Category
      </h2>
        ...
        {mounted && !isCategoriesLoading && categories.length > 0 ? (
          <>
            ...
            <button
              ...
              aria-label="Previous"
              className="absolute top-1/3 left-0 md:-left-6 -translate-y-1/2 z-10 text-(--secondary) px-3.5 pb-1 text-2xl bg-(--primary) rounded-full cursor-pointer"
            >
              ‹
            </button>
            <button
              ...
              aria-label="Next"
              className="absolute top-1/3 right-0 md:-right-4 -translate-y-1/2 z-10 text-(--secondary) px-3.5 pb-1 text-2xl bg-(--primary) rounded-full cursor-pointer"
            >
              ›
            </button>
          </>
      ...
      <div className="text-center md:mb-10">
        <Link
          href="/Category"
          className="inline-block text-lg font-semibold px-8 py-2 rounded-md border-2 border-(--primary) text-(--secondary) hover:bg-(--primary) hover:text-white transition duration-200"
        >
          All Categories
        </Link>
      </div>
