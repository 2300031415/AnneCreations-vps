...
const buildProductImageUrl = (image) => {
    ...
    return apiBase ? `${apiBase}/${normalizedImage}` : `/${normalizedImage}`;
};
                ...
                {pendingQuickAdd && (
                    <Box sx={{
                        ...
                        <Box sx={{ display: 'flex', gap: 2.5 }}>
                            <Box sx={{ width: 80, height: 80, borderRadius: 2, overflow: 'hidden', flexShrink: 0, boxShadow: 2 }}>
                                <img
                                    src={buildProductImageUrl(pendingQuickAdd.image)}
