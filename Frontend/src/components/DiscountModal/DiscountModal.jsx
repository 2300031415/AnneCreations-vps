      ...
      try {
        ...
        if (data.success && data.data) {
          ...
          if (shownCouponCode !== fetchedCode) {
            // Show modal after 2 seconds delay if this specific coupon hasn't been shown yet
            timerId = setTimeout(() => {
              setOpen(true);
      ...
      <DialogContent sx={{ p: 0, position: 'relative' }}>
        ...
        >
          <CardContent sx={{ p: { xs: 4, md: 6 }, textAlign: 'center' }}>
            ...
            >
              Welcome to Anne Creations! Get {discountType === 'P' ? `${discountPercentage}%` : `₹${discountPercentage}`} off on your order.
