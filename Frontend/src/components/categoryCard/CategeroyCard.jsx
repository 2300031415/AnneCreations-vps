...
const CategoryCard = ({ item, shape = 'square', onClick }) => {
    ...
    >
      ...
      <div
        className={`flex justify-center bg-(--primary)
          ${isCircle ? 'rounded-2xl border-2 border-(--primary)' : 'rounded-md'}`}
        style={{
          width: imageSize,
          height: imageSize,
        }}
      ...
      {/* Category Name */}
      <p className="mt-2 font-semibold text-md text-(--secondary) break-words">
        {item?.name}
      </p>
