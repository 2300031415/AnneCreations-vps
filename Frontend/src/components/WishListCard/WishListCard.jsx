    ...
    >
      ...
      <CardContent sx={{ p: 0, flex: 1, width: '100%' }}>
        <ul className="flex flex-col gap-2 sm:gap-3 w-full">
          <li className="text-md font-semibold text-(--secondary) break-words">{item.productModel || 'Unknown Model'}</li>
          <li className="text-md text-[color:var(--secondary)B2] break-words">{item.sku || 'No SKU'}</li>
          <li className="text-md">
            Price:{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#996E19] via-(--primary) to-[#996E19] font-bold">
          ...
          <li className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full mt-2">
            <button
              ...
              className="rounded-lg px-4 sm:px-5 py-2 cursor-pointer font-semibold hover:bg-(--primary) border-(--primary) border-2 text-(--secondary) text-md w-full sm:w-auto"
            >
              View Details
            </button>
            <button
              onClick={handleRemove}
              className="bg-(--primary) hover:bg-white rounded-lg border-2 border-(--primary) px-4 sm:px-5 py-2 text-(--secondary) text-md font-semibold cursor-pointer w-full sm:w-auto"
            >
              Remove
            </button>
          </li>
