...
const Footer = () => {
  ...
  return (
    <footer className="w-full overflow-hidden mt-20 font-[600] text-[var(--secondary)]">
        ...
        <Container>
          <div className="flex w-full flex-col lg:flex-row flex-wrap justify-between text-[var(--secondary)]">
            ...
            <div className="w-full sm:w-1/2 lg:w-[15%]">
              <h3 className="font-bold text-lg my-4 text-[var(--brand-accent)]">{t('footer.quick_links')}</h3>
            ...
            <div className="w-full sm:w-1/2 lg:w-[20%]">
              <h3 className="font-bold text-lg my-4 text-[var(--brand-accent)]">{t('footer.support')}</h3>
              <ul className="space-y-2 text-white">
            ...
            <div className="w-full lg:w-[20%]">
              <h3 className="font-bold text-lg my-4 text-[var(--brand-accent)]">{t('footer.contact_us')}</h3>
              <ul className="space-y-2 text-md text-white">
                ...
                <li className="flex items-center gap-2 hover:opacity-75 transition">
                  ...
                  >
                    <MdOutlineEmail size={22} color="var(--brand-accent)" className='mr-3' /> support@annecreationshb.com
                  </a>
                </li>

                <li className="pt-4 font-semibold text-[var(--brand-accent)]">{t('footer.follow_us')}</li>
                <li className="flex gap-3">
                  {socialIcons.map((item, index) => (
                    ...
                    >
                      {/* Override icon color to brand accent */}
      ...
      {/* Bottom Bar */}
      <div className="bg-[var(--primary)] py-4 border-t border-[rgba(255,255,255,0.2)]">
        <Container>
          <div className="flex flex-col sm:flex-row  items-center gap-2 text-sm text-white text-center">
