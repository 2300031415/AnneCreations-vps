            ...
            {!showNavigation && (
              <>
                <Link
                  ...
                  className={cn(
                    "text-sm font-medium",
                    pathname === "/customer/login" && "text-[#ccd88f]"
                  )}
                >
                  Sign In
                </Link>
                <Link
                  ...
                  className={cn(
                    "rounded-md bg-[#ccd88f] px-4 py-2 text-sm font-medium text-[#311807]",
                    pathname === "/customer/register" && "bg-[#ccd88f]/90"
                  )}
                >
                  Register
                </Link>
