...
export interface YearlyNewCustomersResponse {
  year: number
  totalNewCustomers: number
  monthlyData: Array<{
    month: number
...
export const dashboardApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getNewCustomers: builder.query<NewCustomersResponse, { days: number }>({
      query: ({ days }) => ({
        url: `/api/dashboard/customers/new?days=${days}`,
        method: 'GET',
      }),
      providesTags: ['Dashboard'],
    }),
    ...
    getYearlyNewCustomers: builder.query<YearlyNewCustomersResponse, { year: number }>({
      query: ({ year }) => ({
        url: `/api/dashboard/customers/new/yearly?year=${year}`,
        method: 'GET',
      }),
      providesTags: ['Dashboard'],
    }),
